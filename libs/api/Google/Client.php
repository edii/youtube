...
require_once PATH_LIBS.'/api/Google/Auth/AssertionCredentials.php';
require_once PATH_LIBS.'/api/Google/Cache/File.php';
require_once PATH_LIBS.'/api/Google/Cache/Memcache.php';
require_once PATH_LIBS.'/api/Google/Config.php';
require_once PATH_LIBS.'/api/Google/Collection.php';
require_once PATH_LIBS.'/api/Google/Exception.php';
require_once PATH_LIBS.'/api/Google/IO/Stream.php';
require_once PATH_LIBS.'/api/Google/Model.php';
require_once PATH_LIBS.'/api/Google/Service.php';
require_once PATH_LIBS.'/api/Google/Service/Resource.php';
