...
require_once '/geometry/Size.php';
require_once '/geometry/Point.php';
...
//namespace core\imagetoolkit\AcImage;

use core\imagetoolkit\geometry\Rectangle as Rectangle;
use core\imagetoolkit\geometry\Size as Size; 
use core\imagetoolkit\geometry\Point as Point;
use core\imagetoolkit\AcColor as AcColor;
use core\imagetoolkit\AcImageJPG as AcImageJPG;
use core\imagetoolkit\AcImageGIF as AcImageGIF;
use core\imagetoolkit\AcImagePNG as AcImagePNG;

use core\imagetoolkit\geometry\IllegalArgumentExceptions as IllegalArgumentExceptions;
use core\imagetoolkit\geometry\FileNotFoundException as FileNotFoundException;
use core\imagetoolkit\geometry\InvalidFileException as InvalidFileException;
use core\imagetoolkit\geometry\GDnotInstalledException as GDnotInstalledException;
use core\imagetoolkit\geometry\UnsupportedFormatException as UnsupportedFormatException;
use core\imagetoolkit\geometry\FileAlreadyExistsException as FileAlreadyExistsException;
use core\imagetoolkit\geometry\FileNotSaveException as FileNotSaveException;
use core\imagetoolkit\geometry\IllegalArgumentException as IllegalArgumentException;
...
class AcImage // extends \Component
{
 ...
 /**
	...
	{
		$a = func_get_args();
		if (count($a) == 1 and $a[0] instanceof Rectangle and $a[0]->isSquare())
		{
			$square = $a[0];
		}
		else if (count($a) == 2 and $a[0] instanceof Point and is_int($a[1]))
		{
